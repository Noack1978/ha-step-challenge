...
**ha-step-challenge** turns daily step counts into a visual race. The participant with the most steps each day wins a stage. Stages accumulate over the full challenge duration and are displayed as an animated race in a built-in sidebar panel.
...
- Animated race panel in the HA sidebar with progress bars, stage calendar, and results table
...
- Registers the race panel in the sidebar under "Step Challenge"
...
**ha-step-challenge** verwandelt tägliche Schrittzahlen in ein visuelles Rennen. Jeden Tag gewinnt der Teilnehmer mit den meisten Schritten eine Etappe. Etappensiege summieren sich über die Challenge-Dauer und werden als animiertes Rennen in einem eingebauten Seitenleisten-Panel dargestellt.
...
- Animiertes Rennpanel in der HA-Seitenleiste mit Fortschrittsbalken, Etappenkalender und Ergebnistabelle
...
**Start**-Button im Rennpanel, oder den Dienst `step_challenge.start` per Dashboard-Button, Skript oder Automation aufrufen.
